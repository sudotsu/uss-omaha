      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-deep text-xl mt-6">
              {data.subheading}
            </p>
          </div>
          ...
          <CardSurface variant="light" padding="lg" className="mb-8">
            <div className="text-center mb-8">
              <h3 className="text-navy text-2xl font-serif font-bold mb-2">
                {data.contact.name}
              </h3>
            ...
            <div className="border-t border-neutral-light/30 pt-6">
              <h4 className="text-navy font-serif font-bold mb-4 text-center">
            ...
            <div className="mt-8 bg-brass/5 rounded-md px-4 py-3 border-l-4 border-brass">
              <p className="text-slate-deep text-sm font-medium text-center">
                {data.organization}
              </p>
              <p className="text-slate-deep text-sm text-center mt-1">
